# Generated by Django 5.2.7 on 2025-10-22 06:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('method', models.CharField(choices=[('RAZORPAY', 'Razorpay'), ('PAYPAL', 'PayPal'), ('COD', 'Cash on Delivery'), ('STRIPE', 'Stripe')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, choices=[('BLACK', 'Black'), ('WHITE', 'White'), ('RED', 'Red'), ('BLUE', 'Blue'), ('GREEN', 'Green'), ('YELLOW', 'Yellow')], max_length=20, null=True)),
